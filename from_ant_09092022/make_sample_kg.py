...
def create_kg(input_file, node_file, id_mapping_file, edges_file):
...
if __name__ == '__main__':
	# input_file = 'samples/robokop2-2_large/sample_with_negs.txt'
	# output_file = 'samples/robokop2-2_large/node_labels_and_names.txt'
	# get_entity_labels_and_names(input_file, output_file)

	input_file = 'samples/robokop2-2_large/sample_with_negs.txt'
	node_file = 'samples/robokop2-2_large/node_labels_and_names.txt'
	id_mapping_file = 'samples/robokop2-2_large/robokop2-2_to_rk2-2large_id_mappings.txt'
	edges_file = 'created_edges.txt'
	create_kg(input_file, node_file, id_mapping_file, edges_file)
